...
const char g_style3[] =
    ...
    "nav ul li{padding:15px;}.container{padding:50px 20px 50px 20px;}.col-25,.col-75{width:100%;margin-top:0;}input[type=submit]{width:100%;margin-top:20px;}"
...
const char g_vld1_threshold[] =
    "<div class=\"row\"><div class=\"col-25\"><label>Threshold Offset (dB)</label></div><div class=\"col-75\"><input type=\"number\" value=\"%u\" name=\"threshold_offset\" min=\"0\" max=\"100\" required %s></div></div>";

const char g_vld1_min_range[] =
    "<div class=\"row\"><div class=\"col-25\"><label>Min Range Filter</label></div><div class=\"col-75\"><input type=\"number\" value=\"%u\" name=\"min_range_filter\" min=\"0\" required %s></div></div>";

const char g_vld1_max_range[] =
    "<div class=\"row\"><div class=\"col-25\"><label>Max Range Filter</label></div><div class=\"col-75\"><input type=\"number\" value=\"%u\" name=\"max_range_filter\" min=\"0\" required %s></div></div>";

const char g_vld1_avg_count[] =
    "<div class=\"row\"><div class=\"col-25\"><label>Distance Avg Count</label></div><div class=\"col-75\"><input type=\"number\" value=\"%u\" name=\"distance_avg_count\" min=\"1\" required %s></div></div>";
...
const char g_vld1_chirp_count[] =
    "<div class=\"row\"><div class=\"col-25\"><label>Chirp Integration Count</label></div><div class=\"col-75\"><input type=\"number\" value=\"%u\" name=\"chirp_integration_count\" min=\"1\" required %s></div></div>";
